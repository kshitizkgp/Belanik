package com.backend.Belanik.auth.config;
...
import com.backend.Belanik.auth.security.jwt.TokenAuthenticationFilter;
import com.backend.Belanik.auth.security.oauth2.CustomOAuth2UserService;
import com.backend.Belanik.auth.security.oauth2.CustomOidcUserService;
import com.backend.Belanik.auth.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
import com.backend.Belanik.auth.security.oauth2.OAuth2AccessTokenResponseConverterWithDefaults;
import com.backend.Belanik.auth.security.oauth2.OAuth2AuthenticationFailureHandler;
import com.backend.Belanik.auth.security.oauth2.OAuth2AuthenticationSuccessHandler;
